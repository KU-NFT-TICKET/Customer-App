          ...
          <div className="container-lg">
            ...
            <div className="collapse navbar-collapse" id="navbarText">
              <ul className="navbar-nav me-auto mb-2 mb-lg-0">
                ...
                <NavLink to="/organizer" className="nav-link">Home</NavLink>
                </li>
                <li className="nav-item">
                <NavLink to="/organizer/create" className="nav-link">Create</NavLink>
                </li>
              </ul>
            ...
            <div className="py-3 ps-3 organizer-btn"><NavLink to="/" className="nav-link"> Customer → </NavLink></div>
          </div>
        </nav>
  	)
  }
...
export default connect(mapStateToProps)(OrganizerNavBar);